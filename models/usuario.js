...
const UsuarioSchema = new Schema({
    usuario: { type: String, unique: true, lowercase: true, required: true },
    password: { type: String, required: true },
    activo: { type: Boolean, default: true, required: true },
    borrado: { type: Boolean, default: false, require: true },
    ...
    fechaAltaUsuario: { type: Date, default: null, required: false },
